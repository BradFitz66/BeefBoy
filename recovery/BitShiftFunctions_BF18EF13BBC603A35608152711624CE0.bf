namespace BeefBoy.Emu.Instructions.Prefixed
{
	public static class BitShiftFunctions
	{
		public static void rlc_c(uint8 operand1, uint16 operand2){
		    Utils.RotateRegister(.left,ref cpu.registers.c,1);
		}
		...
		public static void rlc_hlp(uint8 operand1, uint16 operand2){
			Utils.RotateRegister(.left,ref cpu.registers.c,1);
		}
		...
		public static void rrc_b(uint8 operand1, uint16 operand2){
			Utils.RotateRegister(.right,ref cpu.registers.c,1);
		}
		...
		public static void rrc_hlp(uint8 operand1, uint16 operand2){
			Utils.RotateRegister(.right,ref cpu.registers.c,1);
		}
		...
		public static void rl_hlp(uint8 operand1, uint16 operand2){
		...
		public static void rr_hlp(uint8 operand1, uint16 operand2){
		...
		public static void sla_hlp(uint8 operand1, uint16 operand2){
		...
		public static void sra_hlp(uint8 operand1, uint16 operand2){
		...
		public static void srl_hlp(uint8 operand1, uint16 operand2){
