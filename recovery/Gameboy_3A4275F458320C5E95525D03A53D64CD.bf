	...
	class Gameboy
	{
		...
		public void dumpRAM(int start, int end){
			for(int i=start; i<end; i++){
				Console.WriteLine(scope String()..AppendF("Memory at 0x{0:X2}: 0x{1:X2}",i,bus.readByte((uint16)i)));
			}
		}
		...
		public void testCPU()
		{
			...
			bus.writeByte(0x0, 0xCB);
			bus.writeByte(0x01, 0xe8);
			bus.writeByte(0x03, 0xCB);
			bus.writeByte(0x04, 0xfe);
			bus.writeByte(0x05, 0x57);
			bus.writeByte(0x06, 0x81);
